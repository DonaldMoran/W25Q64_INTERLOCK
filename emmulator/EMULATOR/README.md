...
This project is a heavily modified fork of [jfoucher/pico-6502](https://github.com/jfoucher/pico-6502). It has been significantly rewritten to support the 6522 bridge architecture and 65C02 extensions.
...
Most of the 6502 emulation code is from [this codegolf answer](https://codegolf.stackexchange.com/a/13020) with some additions to add 65C02 instructions and addressing modes.
